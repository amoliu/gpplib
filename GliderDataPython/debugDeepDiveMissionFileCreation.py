...
transferToDockserver = False

''' These are the important parameters for the mission file '''
yo_file_num = 10
goto_ll_num = 91 # 26-PWptGenerator, 27-MER, 28-MDP, 29-HoldingPattern
surf_file_num = 10    # Surfac<N>.ma file to be called. Has no effect here.
do_deep_dive = False   # Should we be diving deep here???
no_comms_time = 1 #12.5
surf_every_time= 3.0
yy,mm,dd,hr,mi = 2012,9,30,21,0 # Date/Time in time-zone specified
...
#mission_file_name = 'REC30.MI'
#mission_file_name = 'OCSDN.MI' # Hehape, GOTO_L90.MA
mission_file_name = 'OCSDS.MI' # Carmen, GOTO_L91.MA
#mission_file_name = 'OCSDO.MI' # Unit294, GOTO_L92.MA
...
surf_every_N_hrs= SurfaceGliderBehavior(start_when=gldrEnums.start_when_enums['BAW_EVERY_SECS'], \
                    when_secs=(surf_every_time*60*60) )
...
#new_yo_beh.SetTargetDepthForDive(90)
...
ggmail.mail('mragan@usc.edu','Mission File autogenerated. %s for glider: %s.'%(mission_file_name, gliderName),msg,mission_file_name)
ggmail.mail('liuxiao37k@gmail.com','Mission File autogenerated. %s for glider: %s.'%(mission_file_name, gliderName),msg,mission_file_name)
ggmail.mail('elizabeth.teel@gmail.com','Mission File autogenerated. %s for glider: %s.'%(mission_file_name, gliderName),msg,mission_file_name)
ggmail.mail('bridgetseegers@gmail.com','Mission File autogenerated. %s for glider: %s.'%(mission_file_name, gliderName),msg,mission_file_name)
ggmail.mail('cwahl@mbari.org','Mission File autogenerated. %s for glider: %s.'%(mission_file_name, gliderName),msg,mission_file_name)
ggmail.mail('dariod@sccwrp.org','Mission File autogenerated. %s for glider: %s.'%(mission_file_name, gliderName),msg,mission_file_name)
ggmail.mail('burt.jones@kaust.edu.sa','Mission File autogenerated. %s for glider: %s.'%(mission_file_name, gliderName),msg,mission_file_name)
