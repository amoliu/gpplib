...
class Omni_NS_MDP2( O_SA_NS_MDP ):
    ''' Sub-class of O_SA_NS_MDP dealing with the new type of Risk-map
    '''
    def __init__(self,shelfName='RiskMap3.shelf',sfcst_directory='./',dMax=1.5):
        super(Omni_NS_MDP2,self).__init__(shelfName,sfcst_directory,dMax)
    ...
    def GetIndexedPolicy(self,yy,mm,dd,numDays,goal,**kwargs):
		...
		print 'Policy not found. Not sure what to do!'
		'''
                policyTable.close()
