...
dr = DateRange(2013,8,12,2013,8,12)
...
wayPtList = [(33.449855,-118.359328),(33.46926,-118.418188)]
#wayPtList = [(33.543039, -118.331636),(33.523829,-118.588117),(33.488213,-118.701459),(33.522344,-118.757254)]
...
if numThreads< len(dr.DateList)*len(wayPtList):
    ...
    for yy,mm,dd in dr.DateList:
        for lat,lon in wayPtList:
            ...
            cmd = 'nohup nice -n 20 python PreComputePolicy_Omni_NS_MDP_GP.py %04d %02d %2d %f %f &'%(yy,mm,dd,lat,lon)
            print cmd
            os.system(cmd)
            time.sleep( 45 )
