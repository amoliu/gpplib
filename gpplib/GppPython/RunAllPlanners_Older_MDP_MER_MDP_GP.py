...
# Save results...
plannerResults = shelve.open('GPMDP_FNMDP_SARP_RMRRP.shelve')
plannerResults['rmdprPr'] = rmdprPr
plannerResults['rmdprGpPr'] = rmdprGpPr
plannerResults['rsarpPr'] = rsarpPr
plannerResults['rmrrpPr'] = rmrrpPr
