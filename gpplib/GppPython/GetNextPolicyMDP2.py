...
''' We are going to try to automate the glider communication with this...
'''
import dockserverTalk.dockserverTalk as DT
from dockserverTalk.dialogues import Buffer
import dockserverTalk.fsm
import time
from GliderParse import GliderTermParser, GliderLogger
...
t=DT.ThreadedDockserverComm(dockserver,gliderName,port,
...
AutoGenerateGotoLLfile(new_goto_beh,goto_ll_file_num,'Mission file for MDP policy')
