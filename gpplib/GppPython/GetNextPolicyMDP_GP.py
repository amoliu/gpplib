...
from gpplib.Memoized_MDP_GP import *
...
#            shelfDirectory='.'
#        
#        policyStr = 'PolGP_%s_%04d%02d%02d_%d_G_%d_%d_%.3f_%.3f'%(self.shelfName,yy,mm,dd,numDays,goal[0],goal[1],posNoise,romsNoise)
...
gliderName = 'rusalka'
#gliderName = 'he-ha-pe'
goto_ll_file_num = 01 # GOTO_L28.MA for MDP
...
saMdp.GetTransitionModelFromShelf(yy, mm, dd, numDays, posNoise, conf.myDataDir+'gliderModelGP2' )
...
# --------------- Rusalka runs the Switched Mode GP-based MDP ----------- Aug 17, 2012
start_wLat, start_wLon = 3331.063, -11820.310 # Rusalka at 1st waypoint 12:24 am PST
start_wLat,start_wLon =  3332.874, -11821.958 # Rusalka at 2nd waypoint 03:46 am PST
start_wLat,start_wLon =  3333.851, -11823.438  # Rusalka at 3rd waypoint 06:23 am PST
start_wLat, start_wLon = 3333.060, -11825.970  # Rusalka at 4th waypoint 09:46 am PST. New transition models (still 8/17)
start_wLat, start_wLon = 3331.750, -11828.730  # Rusalka at 5th waypoint 04:27 pm PST
start_wLat, start_wLon = 3331.366, -11828.696  # Rusalka at 6th waypoint 08:04 pm PST
start_wLat, start_wLon = 3330.370, -11830.613  # Rusalka at 7th waypoint 09:01 pm PST
start_wLat, start_wLon = 3330.357, -11832.882  # Rusalka at 8th waypoint 1:37 am PST
start_wLat, start_wLon = 3330.245, -11833.233  # Rusalka at 9th waypoint 3:00 am PST
start_wLat, start_wLon = 3330.127, -11835.419  # Rusalka at 10th waypoint 5:59 am PST
start_wLat, start_wLon = 3331.365, -11835.405  # Rusalka at 11th waypoint 8:21 am PST
start_wLat, start_wLon = 3330.542, -11835.129  # Rusalka at 12th waypoint 8:21 am PST
start_wLat, start_wLon = 3330.256, -11837.33   # Rusalka at 13th waypoint 17:17 pm PST
start_wLat, start_wLon = 3330.742,-11839.140   # Rusalka at 14th waypoint 19:19 pm PST
start_wLat, start_wLon = 3330.834, -11840.231  # Rusalka at 15th waypoint 21:39 pm PST
start_wLat, start_wLon = 3330.400, -11841.966  # Rusalka at 16th waypoint 00:41 am PST
start_wLat, start_wLon = 3330.432, -11841.994  # Rusalka at 17th waypoint 03:21 am PST


# ------------------ RUSALKA runs the Switched Mode GP-based MDP Starting Aug 21, 2012
start_wLat, start_wLon = 3330.604, -11844.688  # Rusalka at 1st waypoint 1:36 am Aug 21, 2012 PST (Bug-fix!)

start_wLat, start_wLon = 3330.520, -11844.306  # Rusalka at 1st waypoint 3:22 am
start_wLat, start_wLon = 3330.284, -11839.754  # Rusalka at 2nd waypoint 10:22 am
start_wLat, start_wLon = 3330.336, -11839.708  # Rusalka at 3rd waypoint 11:22 am
start_wLat, start_wLon = 3329.201, -11839.816  # Rusalka at 4th waypoint 13:37 pm
start_wLat, start_wLon = 3329.201, -11839.816  # Rusalka at 5th waypoint 14:56 pm
start_wLat, start_wLon = 3330.474, -11840.420  # Rusalka at 6th waypoint 17:03 pm
start_wLat, start_wLon = 3330.526, -11839.221  # Rusalka at 7th waypoint 20:03 pm
start_wLat, start_wLon = 3330.811, -11837.239  # Rusalka at 8th waypoint 23:14 pm
start_wLat, start_wLon = 3331.311, -11834.848  # Rusalka at 9th waypoint 02:03 am
start_wLat, start_wLon = 3332.711, -11837.495  # Rusalka at 10th waypoint 05:47 am
start_wLat, start_wLon = 3333.667, -11836.486  # Rusalka at 11th waypoint 09:25 am
start_wLat, start_wLon = 3333.000, -11835.832   # Rusalka at 12th waypoint 12:21 pm
start_wLat, start_wLon = 3331.609, -11835.344  # Rusalka at 13th waypoint 15:11 pm
start_wLat, start_wLon = 3330.503, -11834.001  # Rusalka at 14th waypoint 16:20 pm
