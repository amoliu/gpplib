...
expt1_start = mdpD.dateNumToUnixTime( datenum('2013-8-17 6:30:00') );
expt1_end = mdpD.dateNumToUnixTime(datenum('2013-8-19 23:30:00'));  %1343535910.48285;
...
% Start: 3330.171, -11832.378
startLat = 33 + 30.171/60; startLon = -( 118 + 32.378/60);
[sx,sy] = r.GetXYfromLatLon( startLat, startLon );
plot( sx,sy, 'b^', 'MarkerSize', 14,'LineWidth',2.5 );

% Goal : 3332.494, -11836.914
goalLat = 33 + 26.589/60; goalLon = -( 118 + 20.968/60 );
