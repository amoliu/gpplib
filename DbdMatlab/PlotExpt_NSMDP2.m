...
expt1_start = mdpD.dateNumToUnixTime( datenum('2013-8-16 16:30:00') );
expt1_end = mdpD.dateNumToUnixTime(datenum('2013-8-17 6:30:00'));  %1343535910.48285;
...
startLat = 33 + 32.494/60; startLon = -( 118 + 36.914/60);
